...
//		mergeImage("D:/快盘/libgdx-1.2.0/test/core/assets/gjl/stand", 8,16);
	...
	private static void splitImage(String src,int rows,int cols) throws IOException {  
	    ...
	    String originalImg = "D:\\快盘\\libgdx-1.2.0\\test\\core\\assets\\gjl\\stand\\gjl-move-63-94.png";  
...
//	    int cols = 4;  
	    ...
	    for (int i = 0; i < imgs.length; i++) {  
	        ImageIO.write(imgs[i], "png", new File("D:\\快盘\\libgdx-1.2.0\\test\\core\\assets\\gjl\\stand\\gjl-move-63-94-" + i + ".png"));  
	    }  
